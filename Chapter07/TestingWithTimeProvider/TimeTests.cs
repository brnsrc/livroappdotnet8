...
public class TimeTests
{
    ...
    public void TestDiscountDuringWorkdays()
    {
        ...
        Mock.Get(timeProvider).Setup(s => s.GetUtcNow()).Returns(new DateTimeOffset(year: 2023, month: 11, day: 7, hour: 9, minute: 30, second: 0, offset: TimeSpan.Zero));
    ...
    public void TestDiscountDuringWeekends()
    {
        ...
        Mock.Get(timeProvider).Setup(s => s.GetUtcNow()).Returns(new DateTimeOffset(year: 2023, month: 11, day: 4, hour: 9, minute: 30, second: 0, offset: TimeSpan.Zero));
