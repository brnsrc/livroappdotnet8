...
//For evaluation purposes, feel free touse the QuestPDF Comunity
//License in a non-production enviroment
...
WriteLine("PDF catalog has been created: {0}", Path.Combine(
...
try
{
    ...
    {
        WriteLine("Openthe file manually.");
    }
}
catch (Exception ex)
{
