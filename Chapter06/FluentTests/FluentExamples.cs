...
using FluentAssertions.Extensions; // To use common fluent assertions extension
...
public class FluentExamples
{
    ...
    public void TestCollections()
    {
        ...
        names.Should().HaveCountLessThan(
            4, "because the maximum tiems should be 3 or fewer");
    ...
    {
        DateTime when = new(
            hour: 9, minute: 30, second: 0, day: 25, month: 3, year: 2024);
        ...
        DateTime due = new(
            hour: 13, minute: 30, second: 0, day: 25, month: 3, year: 2024);
